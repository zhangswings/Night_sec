...
//                                                            MyClient.cancleClient();
                                                            MyClient.cancleClient(ActivityOut.this);
...
//                                                       client.cancelRequests(ActivityOut.this, true);
                                                       MyClient.cancleClient(ActivityOut.this);
                                                       MyClient.post(ActivityOut.this,"http://" + preferences.getString("ip", "192.168.0.187") + ":8092/JsonHandler.ashx?doc=GetSupplier", params, new AsyncHttpResponseHandler() {
                                                                   @Override
